...
async function deactivateAccount() {
  ...
  redirect("/api/auth/signout?callbackUrl=/login?account=deactivated");
}
...
//       showReviewsPublicly: false,
//       showBadgesPublicly: false,
...
async function deleteAccount() {
  ...
  redirect("/api/auth/signout?callbackUrl=/login?account=deleted");
}
