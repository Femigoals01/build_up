...
//             <div className="flex-1 rounded-[24px] border border-slate-200 bg-slate-50 px-3 py-2 shadow-sm transition focus-within:border-indigo-400 focus-within:bg-white focus-within:ring-4 focus-within:ring-indigo-100">
//               <input
//                 value={input}
//                 onChange={(e) => {
...
//     if (!chat || !session?.user || !audioPreview) return;
...
//               className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-slate-200 bg-slate-100 text-lg text-slate-700 shadow-sm hover:bg-slate-200"
//               title="Attach file"
//               type="button"
//             >
//               📎
