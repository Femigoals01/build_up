...
//   return (
//     <main className="min-h-screen bg-[linear-gradient(180deg,#f8fafc_0%,#ffffff_38%,#eef4ff_100%)] px-4 py-6 md:px-8 lg:px-10 lg:py-8">
...
//             <Stat title="Completed" value={completedProjects} icon="✅" tone="slate" />
//             <Stat title="Volunteers" value={totalVolunteers} icon="🧑‍💻" tone="amber" />
//           </div>
//         </section>
...
//               </h2>
//               <p className="mt-2 text-sm leading-6 text-slate-500">
//                 When a project is assigned to you, it will appear here together
