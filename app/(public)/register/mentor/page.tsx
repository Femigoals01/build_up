...
//       }}
//       className="h-12 min-w-0 flex-1 rounded-2xl border border-slate-200 bg-slate-50 px-4 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-100"
//     />
...
//         }
//       }}
//       className="h-12 rounded-2xl bg-indigo-600 px-5 text-sm font-semibold text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-60"
//     >
...
//     Got invited by a mentor, volunteer, or organization? Enter their referral
//     code.
//   </p>
// </div>
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                  ...
                  <p className="text-xs text-slate-500">
                    {selectedCountry
                      ? `Selected country: ${selectedCountry.name}. ${
                          countryCode === "+234"
                            ? "Enter exactly 10 digits after +234."
                            : "Enter numbers only."
                        }`
                      : "Choose your country and country code before entering your number."}
                  </p>
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      <input
                        ...
                        className="h-12 min-w-0 flex-1 rounded-2xl border border-slate-200 bg-slate-50 px-4 text-sm uppercase text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-100"
                      />
                    ...
                    <p className="mt-2 text-xs text-slate-500">
                      Got invited by a mentor, volunteer, or organization? Enter
                      their referral code.
                    </p>
                  </div>
