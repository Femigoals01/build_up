    ...
    <>
      ...
      <main className="overflow-x-hidden bg-white text-slate-900">
        ...
        >
          ...
          <div className="mx-auto max-w-[1400px] px-0.5 pb-0.5 pt-0.5 sm:px-0.5 lg:ps-5 lg:pe-0.5 lg:pb-0.5 lg:pt-0.5">
            <div className="grid items-center gap-6 lg:grid-cols-[1.04fr_0.96fr] lg:gap-10">
              ...
              <div className="relative order-first lg:order-none">
                <div className="relative -mx-4 sm:-mx-6 lg:mx-0">
                  ...
                  <div className="relative h-[320px] sm:h-[400px] md:h-[500px] lg:h-auto lg:min-h-[620px]">
                    <Image
                      src="/hero-right.png"
        ...
        <section className="relative mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="absolute inset-x-6 top-10 -z-10 h-48 rounded-[3rem] bg-gradient-to-r from-blue-50 via-indigo-50 to-cyan-50 opacity-80 blur-3xl lg:inset-x-20" />
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 text-base leading-8 text-slate-600 sm:text-lg">
                ...
                ability. BuildUp closes that gap by connecting learning to live
                work, mentors, organizations, stipends, and visible proof.
              </p>
            </div>
        ...
        >
          <div className="absolute inset-x-6 top-8 -z-10 h-40 rounded-[2.5rem] bg-gradient-to-r from-blue-50 via-indigo-50 to-cyan-50 opacity-70 blur-3xl lg:inset-x-20" />
          ...
          <div className="grid gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-16">
            <div className="max-w-2xl">
              ...
              <div className="mt-8 space-y-4">
                <p className="text-base leading-8 text-slate-600 sm:text-lg">
                  ...
                  <strong className="text-slate-900"> organizations</strong>,
                  and
                  <strong className="text-slate-900"> mentors</strong> to work
                  on real projects and build proven experience.
                </p>

                <p className="text-base leading-8 text-slate-600 sm:text-lg">
                  Instead of just certificates, you gain{" "}
                  <span className="font-semibold text-slate-900">
                    real work, portfolio proof, mentor feedback, and practical
                    visibility.
                  </span>
                </p>
            ...
            <div className="relative">
              <div className="absolute -inset-3 rounded-[2.25rem] bg-gradient-to-br from-blue-100 via-indigo-100 to-cyan-100 opacity-80 blur-2xl" />
          ...
          {projects.length === 0 ? (
            ...
            <div className="mt-10 grid gap-y-6 md:grid-cols-2 md:gap-x-6 xl:grid-cols-4 xl:gap-x-0 xl:divide-x xl:divide-slate-200">
              {projects.map((project) => (
                <div
                  key={project.id}
                  className="xl:px-6 first:xl:pl-0 last:xl:pr-0"
                >
                  <Link
                    href="/register/volunteer"
        ...
        >
          ...
          <div className="mt-14 grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-center">
            <div className="relative rounded-[36px] border border-slate-200 bg-gradient-to-br from-white via-blue-50/50 to-indigo-50 p-6 shadow-[0_24px_80px_rgba(37,99,235,0.10)] sm:p-8">
