...
//                 <div
//                   className={`absolute right-0 top-[calc(100%+10px)] w-64 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_20px_50px_rgba(15,23,42,0.12)] transition-all duration-200 ${
//                     startOpen
...
//                       // subtitle="Gain real experience through live projects"
//                       // icon="🙋"
...
//                       // subtitle="Post real work and find emerging talent"
//                       // icon="🏢"
//                       onClick={() => setStartOpen(false)}
//                     />
//                     <DropdownLink
...
//                       // subtitle="Guide volunteers and shape real outcomes"
//                       // icon="🧑‍🏫"
//                       onClick={() => setStartOpen(false)}
//                     />
//                   </div>
...
//       href={href}
//       onClick={onClick}
//       className="group relative block rounded-xl px-4 py-3 transition-all duration-200 hover:bg-slate-50"
//     >
...
//       {/* subtle hover line */}
//       <span className="absolute left-4 bottom-2 h-[2px] w-0 bg-blue-600 transition-all duration-300 group-hover:w-6" />
//     </Link>
//   );
// }
...
//       href={href}
//       onClick={onClick}
//       className="block rounded-xl bg-white px-3 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-100"
//     >
//       {label}
//     </Link>
//   );
